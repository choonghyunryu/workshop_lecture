...
# 로그 파일경로 및 이름
log_file=`expr $work_dir/log/trade_apt_$YMD_.log`
...
```{r, eval=FALSE}
(base) choonghyunryu@myWorld R % cat ../log/trade_apt_.log 
Start Job - NA211974 cases of data were collected.Finsh Job - NA%                                                                                     (base) choonghyunryu@myWorld R % 
```
